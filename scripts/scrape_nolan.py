...
search_dir = Path("/Users/michaelharoon/Projects/tasty/kalshi-polymarke-march-madness/data/raw/html")

HTML_FILES = [f for f in search_dir.iterdir() if f.is_file()]
OUTPUT_FILE = '/Users/michaelharoon/Projects/tasty/kalshi-polymarke-march-madness/data/{date}_Team_Sheet_Final.csv'
